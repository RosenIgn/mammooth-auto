    ...
    <div className="max-w-7xl mx-auto p-12 mt-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="relative">
          ...
          />
          <div className="absolute bottom-7 left-0 right-0 bg-black bg-opacity-50 text-white p-4 rounded-b-lg">
        ...
        <div>
          ...
          <div className="mt-4 space-y-2">
            ...
            {/* <p className="text-gray-200"><span className="font-semibold">Описание:</span> {car.description}</p> */}
