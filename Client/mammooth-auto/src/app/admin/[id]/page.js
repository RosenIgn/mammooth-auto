  ...
  return (
    <div className="container mx-auto mt-5 px-4">
      ...
      <div className="border p-4 rounded-lg shadow-md">
        ...
        <h3 className="text-lg font-semibold text-gray-500">{car.brand} {car.model}</h3>
        ...
        <p className="text-gray-500">
          Потребителска цена: {car.priceFromUser ? car.priceFromUser.toLocaleString() : "Няма информация за"} лв.
        </p>
        <p className="text-gray-500">
          Продажна цена: {car.sellingPrice ? car.sellingPrice.toLocaleString() : "Няма информация за"} лв.
        </p>

        <p className="font-bold">Статус: {car.status}</p>
